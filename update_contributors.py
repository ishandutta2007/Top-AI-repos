...
def update_readme(repo_slug, contributors):
    ...
    for c in contributors:
        ...
        html_output.append(f'<a href="{html_url}"><img src="{avatar}&s=32" width="32" height="32" alt="{login}" /></a>')
    ...
    start_marker = "A huge thank you to everyone who has contributed to this project!\n\n"
    header = "## 👥 Contributors"
    ...
    if start_index != -1 and end_index != -1:
        ...
        new_readme = readme[:start_index + (len(start_marker) if "A huge thank you" in start_marker else 0)] 
